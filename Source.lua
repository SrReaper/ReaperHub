...
local Tab1 = Init:NewTab("Troll Scripts")

local Tab2 = Init:NewTab("Universal for old games")
...
local Label1 = Tab1:NewLabel("Scripts", "Center")--"left", "center", "right

local Label2 = Tab2:NewLabel("Tools By ilyreaper on discord")

local Label3 = Tab3:NewLabel("Tools By Jvoidluxx")

local Button1 = Tab1:NewButton("Load", function()
    print("one")
end)

local Button2 = Tab1:NewButton("Load", function()
    print("two")
end)

local Textbox1 = Tab2:NewTextbox("Fling(Put their user in the textbox)", "", "1", "all", "small", true, false, function(val)
    print(val)
end)

local Selector1 = Tab2:NewSelector("Selector Testing", "Choose", {"Yes", "No", "Perhaps", "Perhaps Not"}, function(d)
    print(d)
end):AddOption("Yes")
...
local Toggle1 = Tab2:NewToggle("Speed", false, function(value)
...
local FinishedLoading = Notif:Notify("Loaded Sucessfully", 4, "success")
